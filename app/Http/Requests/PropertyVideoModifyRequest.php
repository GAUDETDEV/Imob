...
class PropertyVideoModifyRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'video' => 'video|mimes:mp4,mov,ogg,qt|max:20000', // Limite de 2MB pour la photo
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'video.video' => 'Veulliez importer une video svp!',
