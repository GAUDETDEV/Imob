...
<body>
    <div class="boxed_wrapper">
            ...
            <div class="container">
                <div class="content-box p_relative">
                    ...
                    <ul class="bread-crumb">
                        ...
                        <li><span class="icon-57"></span>Team</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <!-- team-section -->
        <section class="our__team p_relative see__pad">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 p-xl-0 pb-30">
                        <div class="team__content one p_relative">
                            <div class="anim-icon">
                                <div class="icon icon-01 float-bob-y" style="background-image:url(assets/images/icons/icon-08.svg)"></div>
                            </div>
                            <div class="team__block">
                                <div class="inner-box">
                                    ...
                                    <div class="lower__content p_relative">
                                        <div class="anim-icon">
                                            <div class="icon icon-02 float-bob-x" style="background-image:url(assets/images/shape/shape-07.png)"></div>
                                        </div>
                                        ...
                                        <div class="team__info">
                                            <div class="team__left">
                                                <h4><a href="team-details.html">Vinnay <span>Duya</span></a>  </h4>
                                                <p>Ex Advisor</p>
                                            </div>
                                            <div class="team__right">
                                                <ul>
                                                    <li><a href="mailto:info@gmail.com"> <span class="icon-icon-30"></span> </a></li>
                                                    <li><a href="tel:974364364367"> <span class="icon-icon-35"></span> </a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 p-xl-0 pb-30">
                        <div class="team__content two p_relative">
                            <div class="anim-icon">
                                <div class="icon icon-01 float-bob-y" style="background-image:url(assets/images/icons/icon-20.svg)"></div>
                            </div>
                            <div class="team__block">
                                <div class="inner-box">
                                    <div class="image-box">
                                    ...
                                    <div class="lower__content p_relative">
                                        ...
                                        <div class="team__info">
                                            <div class="team__left">
                                                <h4><a href="team-details.html">Jane <span>Cooper</span> </a></h4>
                                                <p>Brocker & Advisor</p>
                                            </div>
                                            <div class="team__right">
                                                <ul>
                            ...
                            <div class="team__block">
                                <div class="inner-box">
                                    ...
                                    <div class="lower__content p_relative">
                                        ...
                                        <div class="team__info">
                                            <div class="team__left">
                                                <h4><a href="team-details.html">Jon <span>Kayno</span></a> </h4>
                                                <p>CEO & Director </p>
                                            </div>
                                            <div class="team__right">
                                                <ul>
                            ...
                            <div class="team__block">
                                <div class="inner-box">
                                    ...
                                    <div class="lower__content p_relative">
                                        ...
                                        <div class="team__info">
                                            <div class="team__left">
                                                <h4><a href="team-details.html">Elanor <span>Pena</span></a> </h4>
                                                <p>Ex CEO & Director </p>
                                            </div>
                                            <div class="team__right">
                                                <ul>
                            ...
                            <div class="team__block">
                                <div class="inner-box">
                                    ...
                                    <div class="lower__content p_relative">
                                        ...
                                        <div class="team__info">
                                            <div class="team__left">
                                                <h4><a href="team-details.html">Courtney <span>Hary</span></a> </h4>
                                                <p>Ex Director </p>
                                            </div>
                                            <div class="team__right">
                                                <ul>
                        ...
                        <div class="team__content one p_relative">
                            ...
                            <div class="team__block">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image">
                                            <a href="team-details.html"><img src="assets/images/team/team-06.png" alt=""></a>
                                        </figure>
                                    </div>
                                    <div class="lower__content p_relative">
                                        <div class="anim-icon">
                                        ...
                                        <div class="team__info">
                                            <div class="team__left">
                                                <h4><a href="team-details.html">Guy <span>Hawkins</span></a> </h4>
                                                <p>Ex Brocker </p>
                                            </div>
                                            <div class="team__right">
                                                <ul>
