...
<body>
    <div class="boxed_wrapper">
            ...
            <div class="container">
                <div class="content-box p_relative">
                    ...
                    <ul class="bread-crumb">
                        ...
                        <li><span class="icon-57"></span>Services Details</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <div class="sidebar__page__container see__pad">
            <div class="container">
                <div class="row">
                    <!--Content Side-->
                    <div class="sidebar__side col-xl-4 col-lg-4 col-md-6 col-sm-12">
                        <aside class="sidebar">
                            <div class="sidebar__widget">
                                <ul class="service__details__1__cat">
                                    <li ><a href="property-management.html">Property Management <span class="icon-icon-49"></span></a></li>
                                    <li class="active"><a href="mortgage-service.html">Mortgage Service <span class="icon-icon-49"></span></a></li>
                                    <li><a href="consulting-service.html">Consulting Service <span class="icon-icon-49"></span></a></li>
                                    <li><a href="home-selling.html">Home Selling <span class="icon-icon-49"></span></a></li>                                
                                    <li><a href="home-buying.html">Home Buying <span class="icon-icon-49"></span></a></li>
                                    <li><a href="escrow-services.html">Escrow Services <span class="icon-icon-49"></span></a></li>
                                </ul>
                            </div>
                            ...
                            <div class="service__news__letter p_relative mb-30">
                                <div class="icon-layer" style="background-image:url(assets/images/shape/shape-19.png)"></div>
                                <div class="news__letter__content">
                                    ...
                                    <div class="form-inner p_relative">
                                        <form action="index.html" method="post" class="subscribe-form">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="common-btn btn__one">Subscribe</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                    ...
                    <div class="content__side col-xl-8 col-lg-8 col-md-6 col-sm-12 order-lg-2 ps-xl-4">
                        <div class="services__single">
                            <div class="inner__box">
                                 <div class="image__box">
                                     <figure>
                                         <img src="assets/images/resource/service-details-banner.png" alt="">
                                     </figure>
                                 </div>
                                 <div class="content__box">
                                ...
                                <div class="service_benifits pt-30">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-12">
                                            <div class="service_benifits__left">
                                                <figure class="image">
                                                    <img src="assets/images/resource/benifits.png" alt="">
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-12 pr-xl-0">
                                            <div class="service_benifits__right">
                                                <h4>Service Benifits</h4>
                                                <p>Sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut.</p>
                                                <div class="benifits__list">
                                                    <ul>
                                                        <li><span class="icon-icon-49"></span> Nsectetur cing elit.</li>
                                                        <li><span class="icon-icon-49"></span> Suspe ndisse suscipit sagittis leo.</li>
                                                        <li><span class="icon-icon-49"></span> Entum estibulum dignissim posuere.</li>
                                                        <li><span class="icon-icon-49"></span> Donec eros libero, dignissim eget.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="content_block_faq pt-40">
                                    ...
                                    <ul class="accordion-box alt">                            
                                        ...
                                        <li class="accordion block active-block">
                                            <div class="acc-btn active">
                                                <div class="icon-outer">
                                                    <span class="icon-icon-38"></span>
                                                    <span class="icon-icon-11"></span>
                                                </div>
                                              <span class="body__one">How can I make a change to my application?</span>  
                                            </div>
                                        ...
                                        <li class="accordion block">
                                            <div class="acc-btn">
                                                ...
                                                <span class="body__one">How can i make refund from your website? </span> 	
                                            </div>
                                        ...
                                        <li class="accordion block">
                                            <div class="acc-btn">
                                                ...
                                                <span class="body__one">Are my details secured?  </span> 		
                                            </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column p-lg-0">
                            <div class="footer-widget links-widget">
                               ...
                               <!-- page-title -->
         <section class="page__title p_relative" style="background: #EAF7F4;border-radius: 50px 50px 0px 0px;">
            <div class="anim-icon">
                <div data-parallax='{"x": -200}' class="icon layer-bg" style="background-image:url(assets/images/shape/shape-18.png)"></div>
            </div>
            <div class="container">
        ...
        <!-- page-title end-->  <div class="widget-content">
