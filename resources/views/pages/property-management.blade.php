                        ...
                        <aside class="sidebar">
                            <div class="sidebar__widget">
                                <ul class="service__details__1__cat">
                                    <li class="active"><a href="property-management.html">Property Management <span class="icon-icon-49"></span></a></li>
                                    <li><a href="mortgage-service.html">Mortgage Service <span class="icon-icon-49"></span></a></li>
                    ...
                    <div class="content__side col-xl-8 col-lg-8 col-md-6 col-sm-12 order-lg-2 ps-xl-4">
                        <div class="services__single">
                            <div class="inner__box">
                                 <div class="image__box">
                                     <figure>
                                         <img src="assets/images/resource/service-details-banne-06.png" alt="">
                                     </figure>
                                 </div>
                                 <div class="content__box">
