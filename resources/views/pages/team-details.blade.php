...
<title>Houlist - HTML 5 Template Preview</title>
    ...
    <div class="boxed_wrapper">
        ...
        <header class="main-header style-three">
            ...
            <div class="header-lower">
                <div class="outer-box">
                    <div class="logo-box">
                        <figure class="logo"><a href="index.html"><img src="assets/images/logo-two.png" alt=""></a></figure>
                    </div>
                    <div class="menu-area">
        ...
        <!-- End Mobile Menu -->
          ...
          <section class="page__title p_relative">
            <div class="bg-layer parallax-bg" data-parallax='{"y": 20}' style="background-image:url(assets/images/resource/page-title.png)">
            </div>
            <div class="container">
                <div class="content-box p_relative">
                    <h1 class="title">Our Team Details</h1>
                    <ul class="bread-crumb">
                        <li><a href="index.html"><span class="icon-icon-16"></span>Home</a></li>
                        <li><span class="icon-57"></span>Team Details</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <div class="sidebar__page__team see__pad">
            <div class="container">
                <div class="row">
                    <div class="sidebar__side col-lg-4 col-md-12 col-sm-12">
                        <aside class="sidebar">
                            ...
                            <div class="sidebar__widget team__from">       
                                <div class="team__from__title">
                                    <h4>Contact for any Inquiry</h4>
                                    <form method="post" action="sendemail.php" id="contact-form" class="default-form" novalidate="novalidate"> 
                                        <div class="row clearfix">
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                <label><span class="icon-icon-22"></span> Name*</label>
                                                <input type="text" name="name" placeholder="Name" required="" aria-required="false">
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                <label><span class="icon-icon-30"></span> Email*</label>
                                                <input type="email" name="email" placeholder="Email Address" required="" aria-required="false">
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                <label><span class="icon-icon-33"></span> Subject</label>
                                                <input type="text" name="subject" required="" placeholder="Subject" aria-required="false">
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                <label><span class="icon-icon-32"></span> Message</label>
                                                <textarea name="message" placeholder="Message"></textarea>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                <button class="common-btn btn__one" type="submit" name="submit-form">Submit Message <i class="icon-icon-51"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>    
                            </div> 
                            <div class="sidebar__widget sidebar__widget_network">                            
                                <div class="brochure__box">
                                    <div class="image__box">
                                        <figure class="image">
                                    ...
                                    <div class="content__box">
                                        <div class="text">
                                            <h5>Do you want to join our <br>
                                                real estate network?</h5>
                                        </div>
                                        <div class="network__btn">
                                            <a href="contact.html" class="btn-1">
                                                Contact Us
                                                <span></span>
                                            </a>
                    ...
                    <div class="content__sidebar col-lg-7 col-md-12 col-sm-12 order-lg-2 ps-lg-4">
                        <div class="services__right">
                            <div class="inner__box">
                                <div class="team__block__one">
                                    ...
                                    <div class="team__media">
                                        <ul>
                                            <li><a href="index-2.html"> <span class="icon-icon-27"></span> </a> </li>
                                            <li><a href="index-2.html"> <span class="icon-icon-29"></span> </a> </li>
                                            <li><a href="index-2.html"> <span class="icon-icon-14"></span> </a> </li>
                                            <li><a href="index-2.html"> <span class="icon-icon-46"></span> </a></li>
                                            <li><a href="index-2.html"> <span class="icon-icon-50"></span> </a> </li>
                                        </ul>
                                    </div> 
                                </div>   
                                <div class="team__block__two">
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                                </div> 
                                <div class="team__block__three">
                                    <div class="team__block__contact">
                                        <div class="team__block__contact__list">
                                            <div class="team__block__contact__content">
                                                <span class="text__bold">Positions :</span>  <span>Property Seller</span>
                                            </div>
                                            <div class="team__block__contact__content">
                                                <span class="text__bold">Experience : </span>  <span>Good Seller</span>
                                            </div>
                                        </div>
                                        <div class="team__block__contact__list">
                                            <div class="team__block__contact__content">
                                                <span class="text__bold">Practice Area : </span>  <span>USA</span>
                                            </div>
                                            <div class="team__block__contact__content">
                                                <span class="text__bold">Email : </span>  <span><a href="mailto:example@info.com">example@info.com</a> </span>
                                            </div>
                                        </div>
                                        <div class="team__block__contact__list">
                                            <div class="team__block__contact__content">
                                                <span class="text__bold">Fax : </span>  <span> <a href="tel:+0123-456 789">+0123-456 789</a></span>
                                            </div>
                                            <div class="team__block__contact__content">
                                                <span class="text__bold">Phone : </span>  <span> <a href="tel:+0123 456 789">+0123 456 789</a> </span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="team__block__four">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pb-30">
                                            <div class="service__block__one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="effect-romeo image">
                                                            <img src="assets/images/resource/service-08.png" alt="">
                                                        </figure>
                                                    </div>
                                                    <div class="lower__content">
                                                        <div class="service__title">
                                                            <h4> <a href="service.html"> Sun Apartments </a></h4>
                                                        </div>
                                                        <div class="service__text">
                                                            <p>Nullam id nunc nec quam egestas suscipit eu eget ipsum. Quisque ac ligula.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pb-30">
                                            <div class="service__block__one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="effect-romeo image">
                                                            <img src="assets/images/resource/service-09.png" alt="">
                                                        </figure>
                                                    </div>
                                                    <div class="lower__content">
                                                        <div class="service__title">
                                                            <h4> <a href="service.html"> Modern Apartments </a></h4>
                                                        </div>
                                                        <div class="service__text">
                                                            <p>Nullam id nunc nec quam egestas suscipit eu eget ipsum. Quisque ac ligula.</p>
                                                        </div>
