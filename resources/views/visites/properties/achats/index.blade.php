...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card" style="width: 25rem; height: 35rem;">
                    @if($property->mainPhoto())
                        <a href="{{route('visitor.achats.properties.show',$property->id)}}"><img src="{{ Storage::url($property->mainPhoto()->file_path_photo) }}" class="card-img-top" alt="{{ $property->title }}" style="width: 100%; height: 15rem;"></a>
                    @else
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a href="{{route('visitor.achats.properties.show',$property->id)}}">{{ $property->type }}</a></h5>
            ...
            <div class="overlay">
                <h3>Aucun bien à acheter n'a été ajouté!</h3>
            </div>
